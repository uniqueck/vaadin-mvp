package org.vaadin.mvp.vaadinmvp.client.samples;
...
import org.vaadin.mvp.vaadinmvp.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.vaadin.mvp.vaadinmvp.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
